        ...
        <div className='container'>
          <div className='text-center'>
            <h2 className='page-section-heading d-inline-block text-white'>
              ABOUT ME (professionaly speaking...)
            </h2>
          </div>
          ...
          <div className='row'>
            <div className='col-lg-4 ml-auto'>
              <p className='pre-wrap lead'>
                Chris (me) has an ambitious personality and thrives on
                challenges. While setting new goals for myself, he aims for
                results that will make me more productive and effective in my
                environment.
              </p>
            </div>
